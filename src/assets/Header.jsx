                                ...
                                <div className="col-md-6 col-xl-6 col-lg-6 col-sm-6 col-12">
                                    <div className="logo-header-left-section">
                                        <div className="logo-header-img">
                                            <img className="" src={process.env.PUBLIC_URL + "assets/images/logo.png"} />
                                        </div>
                                ...
                                <div className="col-md-6 col-xl-6 col-lg-6 col-sm-6 col-12">
                                    <div className="logo-header-right-section">
                                        ...
                                        <div className="header-phone-email-section">
                                            <ul>
                                                <li><a href="telto:0161 504 0800"><img className="img-fluid" src={process.env.PUBLIC_URL + "assets/images/telephone_icon.png"} /><span>0161 504 0800</span></a></li>
                                                <li><a href="mailto:hello@rdvault"><img className="img-fluid" src={process.env.PUBLIC_URL + "assets/images/mail_icon.png"} /><span>hello@rdvault</span></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="col-md-12 col-xl-12 col-lg-12 col-sm-12 col-12">
                                    <div className="steps-header-center-section">
                                        <div className="steps-header-center-section-content">
                                            <ul>
                                                <li><a href=""><label><img src={process.env.PUBLIC_URL + "assets/images/steppertick.png"} /></label><span>Start</span></a></li>
                                                <li className="active"><a href=""><label>2</label><span>Your Company</span></a></li>
                                                <li><a href=""><label>3</label><span>Your Estimated R&D Claim</span></a></li>
                                            </ul>
                                        </div>
